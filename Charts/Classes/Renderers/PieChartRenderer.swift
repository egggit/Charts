    ...
    public override func drawValues(context context: CGContext)
    {
        ...
        for i in 0 ..< dataSets.count
        {
            ...
            for j in 0 ..< dataSet.entryCount
            {
                ...
                if chart.isDrawOnlyHighlightSliceText == true &&
                    chart.highlighted.count > 0 && chart.highlighted[0].xIndex != xIndex ||
                   chart.isDrawOnlyHighlightSliceText == true && chart.highlighted.count == 0 {
                    // do nothing
                }
